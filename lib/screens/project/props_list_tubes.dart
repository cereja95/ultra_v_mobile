...
class PropsListTubeCell extends StatelessWidget {
  final List<Tube> products;
  Function onTap;

  PropsListTubeCell(this.products, this.onTap);
  ...
  Widget _cellProduct(BuildContext context, int index) {
    ...
    return new InkWell(
        ...
        child: Card(
          ...
          child: products[index].tubeType > 4
              ? Column(
                  children: <Widget>[
                    Container(
                      ...
                      child: Text(status(products[index].tubeType),
