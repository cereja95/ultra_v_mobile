...
class RoomListCell extends StatelessWidget {
  final List<Room> products;
  Function onTap;

  RoomListCell(this.products, this.onTap);
              ...
              Row(children: <Widget>[
                ...
                InkWell(
                    onTap: () {
                      _showDialog(
                          "Atenção",
                          "Deseja realmente remover esse cômodo?",
                          products[index].id);
                    },
                    child: Container(
                      height: 30,
  ...
  Widget formaLista() {
    Widget lista = Center(
      child: Text(
        "Você ainda não possui nenhum cômodo",
